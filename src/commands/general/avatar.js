...
exports.default = {
    ...
    async handleAction(client, context, targetUser) {
        ...
        const s1 = new discord_js_1.SectionBuilder()
            .setThumbnailAccessory(new discord_js_1.ThumbnailBuilder().setURL(avatarUrl))
            .addTextDisplayComponents(new discord_js_1.TextDisplayBuilder().setContent(`# ${emojis_1.default.general.customization} ${targetUser.displayName}'s Avatar\n\n> ${emojis_1.default.general.dot} **[Click here to download](${avatarUrl})**\n\n-# Aura - Made By Aura Devs`));
