...
exports.default = {
    ...
    async handleAction(client, context) {
        ...
        try {
            await player.seek(0);
            await reply((0, containers_1.cv2)((0, containers_1.container)('Replaying the current track.', { title: 'Aura Music', color: 'default' })));
        }
        catch (e) {
            await reply((0, containers_1.cv2)((0, containers_1.container)(`Failed to replay track: ${e.message}`, { title: 'Aura Music', color: 'error' })));
        }
    }
};
